...
def test_command_release_tenderers_amendment(capsys, monkeypatch, caplog):
    assert_streaming(
        capsys, monkeypatch, main, ["upgrade", "1.0:1.1"], ["release_1.0.json"], ["release_1.1.json"], ordered=False
    )
    ...
    assert caplog.records[0].message == (
        ...
        '{"id": "3c9756cf8983b14066a034079aa7aae4", "name": "Acme Inc.", "identifier": {"id": 1}, "additionalIdentifiers": [{"id": "a"}]}\n'  # noqa: E501
...
def test_command_passthrough_release(capsys, monkeypatch, caplog):
    assert_streaming(capsys, monkeypatch, main, ["upgrade", "1.0:1.1"], ["release_1.1.json"], ["release_1.1.json"])
